// Lucide-style inline SVG icons (MIT licensed pattern: lucide.dev).
// Used via Alpine: <span x-html="icons.iconName"></span>
// All icons: 24x24 viewBox, stroke="currentColor", stroke-width=2.
//
// Sizing: control via parent CSS (w-4 h-4, w-5 h-5, etc.) — the SVG inherits.

const SVG_PREFIX = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;display:inline-block;vertical-align:-0.125em">'
const SVG_SUFFIX = '</svg>'
const i = (paths) => `${SVG_PREFIX}${paths}${SVG_SUFFIX}`

window.icons = {
  // Brand / generic
  logo:         i('<path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/>'),   // moon
  ...
  // Status
  dot:          '<span class="inline-block rounded-full" style="width:0.5em;height:0.5em;background:currentColor"></span>',
  ...
  unlink:       i('<path d="m18.84 12.25 1.72-1.71h-.02a5.004 5.004 0 0 0-.12-7.07 5.006 5.006 0 0 0-6.95 0l-1.72 1.71"/><path d="m5.17 11.75-1.71 1.71a5.004 5.004 0 0 0 .12 7.07 5.006 5.006 0 0 0 6.95 0l1.71-1.71"/><line x1="8" y1="2" x2="8" y2="5"/><line x1="2" y1="8" x2="5" y2="8"/><line x1="16" y1="19" x2="16" y2="22"/><line x1="19" y1="16" x2="22" y2="16"/>'),

  // Navigation tabs
  account:      i('<path d="M21 8V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1"/><path d="M21 12h-5a2 2 0 0 0 0 4h5"/>'),
  ...
  mask:         i('<circle cx="9" cy="12" r="1.5"/><circle cx="15" cy="12" r="1.5"/><path d="M3 6c2-3 6-3 6-3v0c0 3-3 5-6 5"/><path d="M21 6c-2-3-6-3-6-3v0c0 3 3 5 6 5"/><path d="M12 18s-3 1-3 3"/><path d="M12 18s3 1 3 3"/><path d="M12 18a6 6 0 0 0 6-6v-1a4 4 0 0 0-4-4h-4a4 4 0 0 0-4 4v1a6 6 0 0 0 6 6Z"/>'),
  ...
  microscope:   i('<path d="M6 18h8"/><path d="M3 22h18"/><path d="M14 22a7 7 0 1 0 0-14h-1"/><path d="M9 14h2"/><path d="M9 12a2 2 0 0 1-2-2V6h6v4a2 2 0 0 1-2 2Z"/><path d="M12 6V3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3"/>'),
  lock:         i('<rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/>'),
  lockOpen:     i('<rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 9.9-1"/>'),
  ...
  smartphone:   i('<rect x="5" y="2" width="14" height="20" rx="2" ry="2"/><line x1="12" y1="18" x2="12.01" y2="18"/>'),
  ...
  stop:         i('<rect x="6" y="6" width="12" height="12"/>'),
  spinner:      '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;display:inline-block;vertical-align:-0.125em" class="animate-spin"><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><line x1="4.93" y1="4.93" x2="7.76" y2="7.76"/><line x1="16.24" y1="16.24" x2="19.07" y2="19.07"/><line x1="2" y1="12" x2="6" y2="12"/><line x1="18" y1="12" x2="22" y2="12"/><line x1="4.93" y1="19.07" x2="7.76" y2="16.24"/><line x1="16.24" y1="7.76" x2="19.07" y2="4.93"/></svg>',
  hourglass:    i('<path d="M5 22h14"/><path d="M5 2h14"/><path d="M17 22v-4.172a2 2 0 0 0-.586-1.414L12 12l-4.414 4.414A2 2 0 0 0 7 17.828V22"/><path d="M7 2v4.172a2 2 0 0 0 .586 1.414L12 12l4.414-4.414A2 2 0 0 0 17 6.172V2"/>'),
  ...
  documents:    i('<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="13" x2="15" y2="13"/><line x1="9" y1="17" x2="13" y2="17"/>'),
  ...
  headphones:   i('<path d="M3 18v-6a9 9 0 0 1 18 0v6"/><path d="M21 19a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2v-3a2 2 0 0 1 2-2h3zM3 19a2 2 0 0 0 2 2h1a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-2H3z"/>'),
  ...
  party:        i('<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01"/><path d="M22 8h.01"/><path d="M15 2h.01"/><path d="M22 20h.01"/><path d="M22 2c-3 3-6 5-6 5l4 4s2-3 5-6c1.293-1.293-1.707-4.293-3-3z"/><path d="m18 18 1 1"/><path d="m12 12 5 5"/>'),
